...
%---------------------------------------------------------------------
%
% Fichero que contiene la generación de la bibliografóa. En principio,
% no haróa falta tenerlo en  un fichero separado, pero como permitimos
...
\def\tituloReferenciasBibliograficas{Referencias Bibliogr\'aficas}
\renewcommand{\bibsection}{\section*{\vspace*{0.5in}\formattitlelistof{\tituloReferenciasBibliograficas}}}
...
% categoría de "parte".
  ...
  \else
    \ifx\tienePartesTeXiS\undefined
      \addcontentsline{toc}{chapter}{\tituloReferenciasBibliograficas}
    \else
      \addcontentsline{toc}{part}{\tituloReferenciasBibliograficas}
    \fi
  \fi
...
%
%
\cabeceraEspecial{\tituloReferenciasBibliograficas}
