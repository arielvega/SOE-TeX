...
%
%    The \leftmark contains the Left argument of the Last \markboth
%    on the page, the \rihtmark contains the Right argument of  the
%    first  \markboth or the only argument of the first  \markright
%    on the page.
%    If no marks  are present  on a page  they are "inherited" from
%    the previous page.
%
...
% \section*, LaTeX aún  no ha definido la posici�n en  el PDF y aunque
...
% eso,  hace referencia al  último marcador  (por ejemplo,  la secci�n
...
\newcommand{\ProximoCapitulo}{En el próximo
  cap\'itulo\ldots\markright{En el próximo capítulo\ldots}}
