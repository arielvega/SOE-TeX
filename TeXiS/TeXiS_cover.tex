...
\def\subtituloPortadaVal{\titulo}
\newcommand{\subtituloPortada}[1]{
\def\subtituloPortadaVal{#1}
}
...
% eso es una exageración, restamos a cada longitud el margen real que
% queremos dejar.
...
\begin{center}
  {\fontsize{16}{24}\textbf{\institucionVal}}
\end{center}
...
\begin{center}
  {\fontsize{14}{20} \textbf{\tituloGradoVal}}
\end{center}


\begin{center}
{\fontsize{16}{24} \textbf{\tituloPortadaVal}}
\end{center}
...
\begin{flushright}
  ...
  {\autorPortadaVal}\\
  \vspace{12pt}
  {\textbf{DIRECTOR DE TRABAJO FINAL DE GRADO:}}\\
  {\directorPortadaVal}
\end{flushright}
