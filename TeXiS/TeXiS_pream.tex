...
% con \RequirePackage, lo  hacemos "explícito" incluyéndolo aqué antes
...
% El paquete  "shortvrb"  supuestamente  define algunas macros cómodas
% como caracteres de escape. Por ejemplo, para poner  un < normalmente
% hay que hacer una  ecuación:   $<$.  Este   paquete  define  algunas
% macros más intuitivas, en este caso bastaría  con \< De igual forma,
% para poner algo en  verbatim, la versión  larga  es \texttt{blabla},
% la  versión  corta  es  \verb+blabla+  (el +  puede  sustituirse por
% cualquier otra cosa,  como un  |  ), y  con  este paquete basta  con
% |blabla|  (es equivalente a \verb|blabla|).  Pero vamos...  a  mí no
% me funciona :-/
\usepackage{shortvrb}
...
% aqué utf8  se asumirá que  *todo* usa UTF-8, incluídos  los ficheros
...
% repercusión  de que  no deberías  dejar lineas  en blanco  en ning�n
...
% Permite tener tablas con tres partes, un "caption", el "cuerpo" y las
% "notas"
...
% y columnas, LaTeX las pinta de manera que dá la sensación de que
...
% paquete para soportar tablas con filas de linea múltiple
\usepackage{multirow}
...
% Paquete que ayuda a establecer los márgenes.
\usepackage{geometry}
...
% Paquete  que permite  establece la fuente a Times New Roman
\usepackage{mathptmx}


% El paquete "tocloft" permite crear nuevos tipos de listas
%
...
% definir.
% Según:  https://tex.stackexchange.com/a/336618  se  debe  cargar  el
% paquete  con  la  opción   [subfigure]   para  evitar  el  error  de
% "LaTeX Error: Command \c@lofdepth already defined."
\usepackage[subfigure,titles]{tocloft}



% El paquete "float" se usa para definir nuevos elementos flotantes que
% funcionan como tablas o figuras.
\usepackage{float}

% "soul" se usa para resaltar texto, necesita el paquete "color", sino
% solo va a subrayar el texto en vez de resaltar
\usepackage{color}
\usepackage{soul}

% "setspace" permite cambiar el interlineado del documento
\usepackage{setspace}

% "titlesec" permite modificar partes del titulo de capítulos
%\usepackage{titlesec}
%\usepackage{sectsty}
...
% "navegar" al visualizar el PDF. Tambien queremos que esos enlaces NO
...
\ifpdf
	\RequirePackage[hyperindex,pdfpagelabels,hidelinks]{hyperref}
...
% Según:  https://tex.stackexchange.com/a/336618  se  debe  cargar  el
% paquete al final, para evitar errores.
\ifpdf
\else
\usepackage{hyperref}
\fi
