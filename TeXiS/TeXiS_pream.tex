...
% automáticamente.  Esto  no  parece   muy  �til,  si  se  piensa  que
...
% aqué utf8  se asumirá que  *todo* usa UTF-8, inclu�dos  los ficheros
...
% Elpaquete "float" se usa para definir nuevos elementos flotantes que
