...
\newcommand{\listofcharts}{\listof{chart}{\thispagestyle{empty} \textbf{\huge \listchartname}}}
...
\newcommand{\listofillustrations}{\listof{illustration}{\thispagestyle{empty} \textbf{\huge \listillustrationname}}}

%
%
% Índice de anexos (List of annexes)
\newcommand{\listannexename}{List of charts}
\newcommand{\listofannexes}{\thispagestyle{empty} \textbf{\huge \listannexename}}
\newlistof{annexe}{loan}{\listofannexes}
\newcommand{\annexe}[1]{%
\refstepcounter{annexe}
\par\noindent\textbf{Annexe \theannexe. #1}
\addcontentsline{loan}{annexe}
{\protect\numberline{\thechapter. \theannexe}#1}\par}
