...
% \institucion{Nombre}
% Puede tener varias l\'ineas. Se utiliza en las dos portadas.
% Si no se indica aparecer\'a vac\'io.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\institucion{%
...
% cambiar el título de forma que se especifiquen d\'onde se quieren
...
\textit{Informe t\'ecnico del departamento}  \\ [0.3em]
\textbf{Ingenier'ia del Software e Inteligencia Artificial} \\ [0.3em]
\textbf{IT/2009/3}
}
